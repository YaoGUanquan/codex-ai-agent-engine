...
> 也参考了 https://github.com/iOfficeAI/OfficeCLI 中关于 Office 自动化与 AI 工作流的设计。<br>
...
- `ae-officecli`：将 OfficeCLI 作为可选外部引擎处理 Office 文档自动化任务。
- `ae-docx`：使用面向 OfficeCLI 的工作流处理 Word 文档任务。
- `ae-xlsx`：使用面向 OfficeCLI 的工作流处理 Excel 任务。
- `ae-pptx`：使用面向 OfficeCLI 的工作流处理 PowerPoint 任务。
...
- `https://github.com/iOfficeAI/OfficeCLI` 主要提供基于 CLI 的 Office 文档自动化、渲染验证和面向 AI agent 的 Office 工作流参考。
