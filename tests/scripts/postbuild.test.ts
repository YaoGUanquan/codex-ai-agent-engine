...
function writeTalkNormalFallback(root: string): void {
  mkdirSync(join(root, 'docs'), { recursive: true })
  writeFileSync(join(root, 'docs', 'talk-normal-fallback.md'), 'Use concise language.\n', 'utf8')
}
...
describe('postbuild 构建脚本', () => {
  ...
  it('应该复制内置技能目录和 references 资产到 dist', () => {
    ...
    expect(readFileSync(join(distSrc, 'assets', 'rules', 'talk-normal.md'), 'utf8')).toBe(
