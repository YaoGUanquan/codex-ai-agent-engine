...
try {
  ...
  const expectedPaths = [
    ...
    'plugins/ai-agent-engine-codex/skills/ae-test-api/SKILL.md',
    ...
    '.agents/skills/ae-test-api/agents/openai.yaml',
  ...
  const expectedBilingualLabels = [
    ...
    ['ae-test-api', 'AE 接口测试 / AE API Test'],
