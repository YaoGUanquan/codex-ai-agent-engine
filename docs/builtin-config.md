...
| 资产 | 场景 |
| --- | --- |
| `/ae-brainstorm`、`/ae-prd`、`/ae-agent-creator`、`/ae-work-report`、`/ae-my-code-changes`、`/ae-prototype-preview`、`/ae-handoff`、`/ae-sql`、`/ae-swagger-parser`、`/ae-api-tester`、`/ae-image`、`/ae-audio`、`/ae-video`、`/ae-graph-build`、`/ae-project-explore`、`/ae-save-experience`、`/ae-prompt-optimize`、`/ae-skill-creator` | `standard` |
| `/ae-design`、`/ae-work`、`/ae-merge-branch`、`/ae-review`、`/ae-slides-outline`、`/ae-task-loop`、`/ae-grill` | `deep` |
