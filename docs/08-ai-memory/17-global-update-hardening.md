...
- Release content changes require synchronized root/package and plugin-manifest versions plus bilingual README/CHANGELOG entries. Version `0.3.39` is the current installed release.
