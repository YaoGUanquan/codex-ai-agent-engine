...
| U4 | Replace unpublished Cursor links with real copies (0.3.30) | `npm test` 145/145; `npm run check`; `npm run check:smoke`; live `/ae` confirmed | implemented |

## Closeout

- Status: done
- Archive: `docs/00-process/archive/2026-08/cursor-user-skill-discovery/`
...
- Slash-palette refresh requires a new Cursor chat; the user confirmed the fresh-thread listing on 2026-08-13.
