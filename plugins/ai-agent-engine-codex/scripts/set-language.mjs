...
const supported = new Set(['en', 'zh-CN', 'bilingual'])
...
for (const root of roots) {
  ...
  for (const [skill, item] of Object.entries(metadata)) {
...
function renderYaml(item, lang) {
  const display = lang === 'zh-CN'
    ? item.display.zh
    : lang === 'bilingual'
