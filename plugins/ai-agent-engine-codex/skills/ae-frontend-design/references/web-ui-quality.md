...
3. Reuse the local design system, routing structure, component patterns, and data-access owners; read `component-data-access-contract.md` before recreating a dialog, drawer, list/table, form, styling pattern, or request path.
