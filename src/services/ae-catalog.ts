...
const REQUIRED_AGENTS: ReadonlyArray<readonly [string, AgentDefinition['stage'], string, string?]> = [
  ...
  [AGENT.STEP_GRANULARITY_REVIEWER, 'review', '审查设计步骤粒度与批量操作可脚本化'],
  [
    AGENT.TEST_CASE_REVIEWER,
    'review',
    '审查测试用例维度的结构完整性、覆盖完备性、步骤可执行性、结果可验证性和需求对齐程度',
  ],
  ...
  [AGENT.PROTOTYPE_REVIEWER, 'review', '审查原型/线框维度的交互完整性、状态覆盖、与需求的一致性以及实现可行性提示'],
